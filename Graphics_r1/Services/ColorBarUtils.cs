...
//    /// <summary>
//    /// カラーバー帯・選択ユーティリティ。
//    /// ColorBaredGeometry を生成し、値から対応するジオメトリを選択するヘルパ群。
//    /// </summary>
//    public static class ColorBarUtils
//    {
//        public static List<ColorBaredGeometry> GetColorBarGeometries(IEnumerable<double> values, int steps = 10)
//        {
...
//            {
//                // 単一値ならひとつのバンドを作る
//                var single = new ColorBaredGeometry
//                {
//                    BottomRange = min,
//                    TopRange = max,
//                    Color = ColorBar.GetColor(0.5)
//                };
//                return new List<ColorBaredGeometry> { single };
//            }
...
//                double norm = (b + t) / 2.0;
//                double ratio = (norm - min) / (max - min);
//                var g = new ColorBaredGeometry
//                {
//                    BottomRange = b,
//                    TopRange = t,
//                    Color = ColorBar.GetColor(ratio)
//                };
//                geoms.Add(g);
//            }
...
//                Color = color
//            };
//            return new List<ColorBaredGeometry> { g };
//        }
...
//            {
//                if (value >= g.BottomRange && value < g.TopRange)
//                    return g;
//            }
//            return null;
//        }
