...
namespace PileDesign.Views
{
    ...
    public partial class EditPileLayoutWindow : Window
    {
        ...
        public EditPileLayoutWindow(MainWindowViewModel mainWindowViewModel)
        {
            _isInitialized = false; // 初期化開始
            InitializeComponent();
            viewModel = new EditPileLayoutViewModel(mainWindowViewModel);
            this.DataContext = viewModel;
            this.Loaded += EditPileLayoutWindow_Loaded;
            //_isInitialized = true; // 初期化完了
        }

        private void EditPileLayoutWindow_Loaded(object sender, RoutedEventArgs e)
        {
            _isInitialized = true;
            // 必要ならLoadedイベントの解除
            this.Loaded -= EditPileLayoutWindow_Loaded;
        ...
        private void ComboBoxPileRef_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (!_isInitialized) return; // 初期化中は無視
            //CheckBoxPileRef.IsChecked = true;
            viewModel.IsApplicablePileRefNo = true;
        }

        private void ComboBoxGroundRef_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (!_isInitialized) return; // 初期化中は無視
            CheckBoxGroundRef.IsChecked = true;
        }

        private void TextBoxPileTopLevel_TextChanged(object sender, TextChangedEventArgs e)
        {
            if (!_isInitialized) return; // 初期化中は無視
        ...
        {
            if (!_isInitialized) return; // 初期化中は無視
            CheckBoxGroupPileFactor.IsChecked = true;
        }

        private void TextBoxVL_TextChanged(object sender, TextChangedEventArgs e)
        {
            if (!_isInitialized) return; // 初期化中は無視
            CheckBoxVL.IsChecked = true;
        }

        private void TextBoxVLadd_TextChanged(object sender, TextChangedEventArgs e)
        {
            if (!_isInitialized) return; // 初期化中は無視
        ...
        private void TextBox1_2_TextChanged(object sender, TextChangedEventArgs e)
        {
            if (!_isInitialized) return; // 初期化中は無視
            CheckBox1_2.IsChecked = true;
        }

        private void TextBox1_3_TextChanged(object sender, TextChangedEventArgs e)
        {
            if (!_isInitialized) return; // 初期化中は無視
            CheckBox1_3.IsChecked = true;
        }

        private void TextBox1_4_TextChanged(object sender, TextChangedEventArgs e)
        {
            if (!_isInitialized) return; // 初期化中は無視
            CheckBox1_4.IsChecked = true;
        }

        private void TextBox2_1_TextChanged(object sender, TextChangedEventArgs e)
        {
            if (!_isInitialized) return; // 初期化中は無視
            CheckBox2_1.IsChecked = true;
        }

        private void TextBox2_2_TextChanged(object sender, TextChangedEventArgs e)
        {
            if (!_isInitialized) return; // 初期化中は無視
            CheckBox2_2.IsChecked = true;
        }

        private void TextBox2_3_TextChanged(object sender, TextChangedEventArgs e)
        {
            if (!_isInitialized) return; // 初期化中は無視
            CheckBox2_3.IsChecked = true;
        }

        private void TextBox2_4_TextChanged(object sender, TextChangedEventArgs e)
        {
            if (!_isInitialized) return; // 初期化中は無視
            CheckBox2_4.IsChecked = true;
        }

        private void CheckBoxIsFront1_Checked(object sender, RoutedEventArgs e)
        {
            if (!_isInitialized) return; // 初期化中は無視
            CheckBoxIsFront1.IsChecked = true;
        }

        private void CheckBoxIsFront2_Checked(object sender, RoutedEventArgs e)
        {
            if (!_isInitialized) return; // 初期化中は無視
            CheckBoxIsFront2.IsChecked = true;
        }

        private void CheckBoxIsFront3_Checked(object sender, RoutedEventArgs e)
        {
            if (!_isInitialized) return; // 初期化中は無視
            CheckBoxIsFront3.IsChecked = true;

        }

        private void CheckBoxIsFront4_Checked(object sender, RoutedEventArgs e)
        {
            if (!_isInitialized) return; // 初期化中は無視
            CheckBoxIsFront4.IsChecked = true;
        }
    }
}
