...
namespace PileDesign.ViewModels
{
    ...
    {
        // 全テーブル
        public ObservableCollection<ResultTable> AllTables { get; } = new();
        // フィルタ後
        public ObservableCollection<ResultTable> FilteredTables { get; } = new();
        ...
        // フィルタ選択肢
        public ObservableCollection<string> LoadCaseFilterOptions { get; } = new();
        public ObservableCollection<string> LoadCombinationFilterOptions { get; } = new();
        public ObservableCollection<string> LiquefactionFilterOptions { get; } = new();
