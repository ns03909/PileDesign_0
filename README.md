...
文献に数値として書かれている **49 項目**を計算し、**49 項目**が文献の許容内です（`TestProject1/LiteratureVerification/LiteratureCatalog.cs` が出典と値を持ち、`VerificationTableTests` が照合してこの表を書き出します）。
...
杭先端の支持力や杭体のせん断耐力の算定を、メーカーが評定・認定の範囲で公表している算定式・対比表・検証用の計算値と照合したものです。学会の指針の再現とは性格が違うので、検証ウィンドウでも別ページにしています。
...
| エムケーパイルリング785 設計施工指針・同解説 (向山工場) | 解表5.2 杭径の検討用試験体 | 使用限界せん断力 QAL (試験体 No.4、杭径 400 mm) | 55.7 kN | 55.7 kN | 0.0% | ±0.5% | 一致 |
| エムケーパイルリング785 設計施工指針・同解説 (向山工場) | 解表5.2 杭径の検討用試験体 | 損傷限界せん断力 QAs (試験体 No.4、杭径 400 mm) | 83.6 kN | 83.55 kN | -0.1% | ±0.5% | 一致 |
| エムケーパイルリング785 設計施工指針・同解説 (向山工場) | 解表5.2 杭径の検討用試験体 | 使用限界せん断力 QAL (試験体 No.12、杭径 700 mm) | 185.3 kN | 185.3 kN | 0.0% | ±0.5% | 一致 |
| エムケーパイルリング785 設計施工指針・同解説 (向山工場) | 解表5.2 杭径の検討用試験体 | 損傷限界せん断力 QAs (試験体 No.12、杭径 700 mm) | 278 kN | 278 kN | 0.0% | ±0.5% | 一致 |
